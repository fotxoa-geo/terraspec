...
# setup directory for output nc file data
nc_out_directory=${out_base}/${fid}/${product}
...
# Run unmixing on image with global library


# Run tetracorder on rfl image


# Create image cube and images for field ipad
