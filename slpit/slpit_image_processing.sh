...
if [ -z "${rfl_uncert}" ]; then
  ...
  # sma calls
  julia -p 40 ../SpectralUnmixing/unmix.jl ${rfl_img} ${NORMALIZED_GLOBAL_LIB_PATH} level_1 ${emc_out_directory}/global_${filebase_name} --mode sma --normalization brightness --num_endmember 20 --n_mc 25 --spectral_starting_col 11 --log_file ${emc_out_directory}/global_${filebase_name}.out --reflectance_uncertainty_file ${rfl_uncert}
  julia -p 40 ../SpectralUnmixing/unmix.jl ${rfl_img} ${NORMALIZED_LOCAL_LIB_PATH} level_1 ${emc_out_directory}/local_${filebase_name} --mode sma --normalization brightness --num_endmember 20 --n_mc 25 --spectral_starting_col 8 --log_file ${emc_out_directory}/local_${filebase_name}.out --reflectance_uncertainty_file ${rfl_uncert}
  julia -p 40 ../SpectralUnmixing/unmix.jl ${rfl_img} ${NORMALIZED_Kalahari_LIB_PATH} level_1 ${emc_out_directory}/kalahari_${filebase_name} --mode sma --normalization brightness --num_endmember 20 --n_mc 25 --spectral_starting_col 11 --log_file ${emc_out_directory}/kalahari_${filebase_name}.out --reflectance_uncertainty_file ${rfl_uncert}

  # mesma calls
  julia -p 40 ../SpectralUnmixing/unmix.jl ${rfl_img} ${NORMALIZED_GLOBAL_LIB_PATH} level_1 ${mesma_out_directory}/global_${filebase_name} --mode mesma --normalization brightness --max_combinations 100 --n_mc 25 --spectral_starting_col 11 --log_file ${mesma_out_directory}/global_${filebase_name}.out --reflectance_uncertainty_file ${rfl_uncert}
  julia -p 40 ../SpectralUnmixing/unmix.jl ${rfl_img} ${NORMALIZED_LOCAL_LIB_PATH} level_1 ${mesma_out_directory}/local_${filebase_name} --mode mesma --normalization brightness --max_combinations 100 --n_mc 25 --spectral_starting_col 8 --log_file ${mesma_out_directory}/local_${filebase_name}.out --reflectance_uncertainty_file ${rfl_uncert}
  julia -p 40 ../SpectralUnmixing/unmix.jl ${rfl_img} ${NORMALIZED_Kalahari_LIB_PATH} level_1 ${mesma_out_directory}/kalhari_${filebase_name} --mode mesma --normalization brightness --max_combinations 100 --n_mc 25 --spectral_starting_col 11 --log_file ${mesma_out_directory}/kalahari_${filebase_name}.out --reflectance_uncertainty_file ${rfl_uncert}
