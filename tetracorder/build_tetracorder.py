...
class tetracorder:
    ...
    def reconstruct_em_sma(self, user_em):
        ...
        complete_fractions_array = envi_to_array(os.path.join(self.tetra_output_directory, 'fractions', 'sma', 'no-brightness', f'tetracorder_soil_spectra_complete_fractions'))
